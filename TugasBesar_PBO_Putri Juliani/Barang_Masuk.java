...
public class Barang_Masuk extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            ...
            String sql = "SELECT * FROM barang_masuk ORDER BY ID_Barang DESC";
    ...
    public void DataEntry(){
        ...
        try {
            ...
            while (r.next()) {
                ...
                BKR [1] = r.getString("Tanggal_Masuk");
     ...
     public void cariDataBarang(){
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from barang_masuk where ID_Barang like '%" + jTextField1.getText() + "%'" +
    ...
    private void initComponents() {
        ...
        jButton1.setText("Barang Keluar");
    ...
    private void txtEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEditActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE barang_masuk SET  Tanggal_Masuk = ?, Customer = ?, NamaBarang = ?, harga = ?,  Stok = ? WHERE ID_Barang = ?";
            PreparedStatement p = c.prepareStatement(sql);
